...
export const FaqList = [
    ...
    },
    {
        ...
        txt: (
            <>
                <p>
                    Following are the 8 types of infographics
                </p>
                <ol >
                    <li>Comparison Infographics</li>
                    <li>Flowchart Infographics</li>
                    <li>How- Infographics</li>
                    <li>List Infographics</li>
                    <li>Map Infographics</li>
                    <li>Process Infographics</li>
